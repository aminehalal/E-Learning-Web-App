    ...
    <body class="bg-blue-100 dark:bg-slate-800 dark:text-white">
        ...
        <div class="grid md:grid-cols-2 font-kanit">
            <div class="flex flex-col justify-center items-center p-24">
                <div>
                    <h1 class="text-4xl font-bold py-3">Improve Your Grades With <span class="text-blue-900">Online Course</span> </h1>
            ...
            <div>
                <img src="img/elearning.jpg" class="h-full w-full">
            </div>
        </div>

        <div class="flex font-kanit flex-col justify-center items-center">
            <div>
                <h1 class="text-3xl font-bold p-2 mt-5">Last Courses</h1>
            </div>
                ...
                <div class="flex flex-col p-2 border-blue-900 m-2 hover:shadow-2xl duration-700 justify-center items-center border-2 rounded-md">
                    ...
                    <div class="flex flex-col justify-center items-center">
                        ...
                        <div class="flex justify-center items-center">
                            @foreach ($tags as $tag)
                            <a href="#" class="p-1 mx-1 bg-blue-800 text-white rounded-lg">{{$tag}}</a>                                    
                            @endforeach
                        </div>
