...
Route::get('/class/{id}' , [StudentController::class , 'classView'])->middleware('auth');
Route::post('/class/post' , [StudentController::class , 'classPost'])->middleware('auth');
Route::post('/class/createVideoChat' , [TeacherController::class , 'classLive'])->middleware('isTeacher');
